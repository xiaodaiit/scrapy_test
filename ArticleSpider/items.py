...
class JobBoleArticleItem(scrapy.Item):
    ...
    front_image_url = scrapy.Field(
        output_processor=MapCompose(return_value)  #备注 out in 都一样返回值
    ...
    def get_insert_sql(self):
        insert_sql = """
            insert into jobbole_article(title,url,fav_nums,create_date)
            VALUES (%s, %s, %s, %s)
        """
        params = (self['title'], self['url'],self['fav_nums'],self['create_date'])
...
class ZhihuQuestionItem(scrapy.Item):
    ...
    def get_insert_sql(self):
        ...
        comments_num = 0   #extract_num("".join(self['comments_num']))
        click_num = 0
...
class ZhihuAnswerItem(scrapy.Item):
    ...
    def get_insert_sql(self):
        #插入知乎answer表的sql
        insert_sql = """
            insert into zhihu_answer(zhihu_id, url, question_id, anthor_id, content, parise_num,
...
class LagouJobItem(scrapy.Item):
    ...
    def get_insert_sql(self):
        ...
        insert_sql = """
            insert into lagou_job_b(title, url, url_object_id, salary, job_city, work_years, degree_need,
            job_type, publish_time, job_advantage, job_desc, job_addr, company_name, company_url,
            tags, crawl_time) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
            ON DUPLICATE KEY UPDATE salary=VALUES (salary), job_desc=VALUES (job_desc)
        """
